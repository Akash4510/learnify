    ...
    <div className="p-4 pt-5 pb-12 md:pb-20 space-y-5">
      ...
      <div className="space-y-3 leading-7">
        <p className="list-item list-inside">
          The sum that a client pays at Learnify site is just for the online
          courses gave in the Product bought by the client. No amount is paid by
          the client to turn into an affiliate with Learnify.
        </p>
        <p className="list-item list-inside">
        ...
        <p className="list-item list-inside">
          ...
          purchaser to the Learnify website for his/her desired product does not
          guarantee any profit or financial return whatsoever.
        </p>
        <p className="list-item list-inside">
          Your use of our information, products, and services should be focused
          on your own proper research, and you acknowledge that Learnify is not
          responsible for any successes and failures of your company that are
          directly or indirectly linked to the purchase and use of our
