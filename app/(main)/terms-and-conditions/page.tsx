    ...
    <div className="p-4 pt-5 pb-12 md:pb-20 space-y-5">
      ...
      <div className="space-y-3 leading-7">
        <p className="list-item list-inside">
          TERMS & CONDITION Welcome to LearnUPIND! These terms and conditions
          outline the rules and regulations for the use of LearnUPIND Website,
          located at{" "}
          <Link href="/" className="text-blue-400 underline underline-offset-2">
            learnupind.com
          </Link>{" "}
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use LearnUPIND if you do not agree to
        ...
        <p className="list-item list-inside">
          ...
          in. Any use of the above terminology or other words in the singular,
          plural, capitalization and/or he/she or they, are taken as
          interchangeable and therefore as referring to same.
        </p>
        <p className="list-item list-inside">
          We employ the use of cookies. By accessing LearnUPIND, you agreed to
          use cookies in agreement with the LearnUPIND&apos;s{" "}
          <Link
            href="/privacy-policy"
        ...
        <p className="list-item list-inside">
          License unless otherwise stated, LearnUPINDand/or its licensors own
          the intellectual property rights for all material on LearnUPIND. All
          intellectual property rights are reserved. You may access this from
          LearnUPIND for your own personal use subjected to restrictions set in
          these terms and conditions. You must not: Republish material from
          LearnUPIND Sell, rent or sub-license material from LearnUPIND
          Reproduce, duplicate or copy material from LearnUPIND Redistribute
          content from LearnUPIND This Agreement shall begin on the date hereof.
        </p>
        <p className="list-item list-inside">
          Our Terms and Conditions were created with the help of the Terms and
          ...
          of the website. LearnUPIND does not filter, edit, publish or review
          Comments prior to their presence on the website.
        </p>
        <p className="list-item list-inside">
          Comments do not reflect the views and opinions of LearnUPIND ,its
          ...
          by applicable laws, LearnUPIND shall not be liable for the Comments or
          ...
          Comments on this website. LearnUPIND reserves the right to monitor all
          ...
          material which is an invasion of privacy The Comments will not be used
          to solicit or promote business or custom or present commercial
          activities or unlawful activity. You hereby grant LearnUPIND a
        ...
        <p className="list-item list-inside">
          ...
          our Website without prior written approval: Government agencies;
          Search engines; News organizations; Online directory distributors may
          ...
          shopping malls, and charity fundraising groups which may not hyperlink
          to our Web site. These organizations may link to our home page, to
          publications or to other Website information so long as the link: (a)
          ...
          site. We may consider and approve other link requests from the
          ...
          requests from these organizations if we decide that: (a) the link
          ...
          compensates the absence of LearnUPIND; and (d) the link is in the
          context of general resource information. These organizations may link
          to our home page so long as the link: (a) is not in any way deceptive;
          ...
          context of the linking party&apos;s site. If you are one of the
          organizations listed in paragraph 2 above and are interested in
          linking to our website, you must inform us by sending an e-mail to
          LearnUPIND. Please include your name, your organization name, contact
        ...
        <p className="list-item list-inside">
          No use of LearnUPIND&apos;s logo or other artwork will be allowed for
          linking absent a trademark license agreement. iFrames Without prior
          approval and written permission, you may not create frames around our
          Webpages that alter in any way the visual presentation or appearance
          of our Website. Content Liability We shall not be hold responsible for
          ...
          libelous, obscene or criminal, or which infringes, otherwise violates,
          or advocates the infringement or other violation of, any third party
          rights. Reservation of Rights We reserve the right to request that you
          remove all links or any particular link to our Website. You approve to
          immediately remove all links to our Website upon request. We also
          reserve the right to amen these terms and conditions and it&apos;s
          linking policy at any time. By continuously linking to our Website,
          you agree to be bound to and follow these linking terms and
          conditions. Removal of links from our website If you find any link on
          our Website that is offensive for any reason, you are free to contact
          and inform us any moment. We will consider requests to remove links
          but we are not obligated to or so or to respond to you directly. We do
          not ensure that the information on this website is correct, we do not
