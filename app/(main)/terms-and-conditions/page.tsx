  ...
  return (
    <div className="p-4 pt-5 pb-12 md:pb-20 space-y-5">
      ...
      <div className="space-y-7 leading-7">
        ...
        <div className="space-y-2">
          <h3 className="text-xl font-bold">General Conditions</h3>
          <p className="list-item list-inside">
        ...
        <div className="space-y-2">
          ...
          <p className="list-item list-inside">
            We have all the rights to cancel the subscription or membership at
            any time without information.
          </p>
          <p className="list-item list-inside">
        ...
        <div className="space-y-2">
          <h3 className="text-xl font-bold">Products Or Services</h3>
          <p className="list-item list-inside">
          ...
          <p className="list-item list-inside">
            ...
            colors and images that appear at the website. We cannot guarantee
          ...
          <p className="list-item list-inside">
            ...
            services that we offer. All descriptions of services or service
        ...
        <div className="space-y-2">
          ...
          <p className="list-item list-inside">
            ...
            Membership you place with us. We may, in our sole discretion, limit
            ...
            same customer account, the same credit card, and/or orders that use
            the same billing and/or shipping address. In the event that we make
          ...
          <p className="list-item list-inside">
            ...
            account information for all purchases made at our website. You agree
        ...
        <div className="space-y-2">
          <h3 className="text-xl font-bold">Optional Tools</h3>
          <p className="list-item list-inside">
        ...
        <div className="space-y-2">
          <h3 className="text-xl font-bold">Third-Party Links</h3>
          <p className="list-item list-inside">
        ...
        <div className="space-y-2">
          <h3 className="text-xl font-bold">Indemnification Severability</h3>
          <p className="list-item list-inside">
        ...
        <div className="space-y-2">
          ...
          <p className="list-item list-inside">
            ...
            by either you or us. You may terminate these Terms and Conditions at
            any time by notifying us that you no longer wish to use our
            Services, or when you cease using our site.
          </p>
          <p className="list-item list-inside">
            If in our sole judgment you fail, or we suspect that you have
            failed, to comply with any term or provision of these Terms and
        ...
        <div className="space-y-2">
          ...
          <p className="list-item list-inside">
            Any ambiguities in the interpretation of these Terms and Conditions
            shall not be construed against the drafting party.
          </p>
        </div>

        <div className="space-y-2">
          <h3 className="text-xl font-bold">Changes To Terms and Conditions</h3>
          <p className="list-item list-inside">
